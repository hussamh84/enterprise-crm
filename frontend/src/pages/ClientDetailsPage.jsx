                ...
                <table className="w-full table-fixed">
                  <thead>
                    <tr className="saas-grid-head text-left">
                      ...
                      <th className="px-4 py-2 text-right w-[140px]">Paid</th>
                      <th className="px-4 py-2 text-right w-[140px]">Remaining</th>
                      <th className="px-4 py-2 text-center w-[120px]">Status</th>
                      <th className="px-4 py-2 text-center w-[120px]">Date</th>
                      <th className="px-4 py-2 text-center w-[160px]">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
